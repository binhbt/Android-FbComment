package com.nguyenmanhquan176.facebookcomments;

import android.app.Activity;

/**
 * Created by framgia on 13/09/2016.
 */
...
public class FbCommentsActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    webView.loadUrl("https://stackoverflow.com/questions/31000081/how-to-use-recyclerview-inside-nestedscrollview");
    setLoading(true);
    loadComments();
  }
